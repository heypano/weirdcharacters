...
class ComponentTwo extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            myOtherStateValue:
                "Update to myStateValue won't change or delete this"
        };
    }
     ...
     */
    render() {
        let valuePassedAsAProp =
            this.props.valuePassedAsAProp ||
            "No value for valuePassedAsAProp passed in the props";
        let stateValue =
            this.state.myStateValue ||
            "No value for myStateValue passed in the state";
